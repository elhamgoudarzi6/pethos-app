...
import { Dimensions, Platform, Linking, Text, TouchableHighlight, Image, View, StyleSheet, StatusBar, BackHandler, Alert, ScrollView, TouchableOpacity, FlatList } from 'react-native';
...
export default class Home extends Component {
  ...
  _renderItem = ({ item, index }) => {
    return (
      <View>
        <View style={{ flex: 1, backgroundColor: '#fff', width: 250, borderRadius: 5, padding: 5, marginHorizontal: 5 }}>
          ...
          <View style={{ flex: 1, marginTop: 110 }}>
            <View style={{ flex: 5, marginTop: 5 }}>
              ...
              <View style={{ alignItems: "flex-end", borderTopColor: "#ececec", borderTopWidth: 0.8, paddingTop: 5, paddingHorizontal: 5 }}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={{ flex: 1, flexDirection: 'row' }}>
            <Icon size={20} name={'sort-amount-desc'} color={'#999'} style={{ backgroundColor: "#f0f1f1", padding: 10, borderRadius: 5, marginRight: 10 }}></Icon>
            <Icon size={20} name={'filter'} color={'#fff'} style={{ backgroundColor: "#01a545", padding: 10, borderRadius: 5 }}></Icon>
          </View>
          <Image source={require('../../../assets/images/logo5.png')} style={{ width: 90, height: 25 }} />
          <FontAwesomeIcon icon={faBars} size={28} style={{ color: '#999', marginLeft: 105 }} onPress={() => this.props.screenProps.openDrawer()} />
        </View>
        <ScrollView>
            ...
            renderItem={({ item, index }) => {
              return (
                <View style={{ backgroundColor: "#fff", marginVertical: 5, borderRadius: 10 }}>
                    ...
                    <View style={[styles.row, { backgroundColor: "#fff", marginTop: 5 }]}>
                      <View style={{ flex: 2, flexDirection: "column", marginRight: 10 }}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', marginTop: 5, justifyContent: "space-between" }}>
                          <Text style={[styles.priceType, { backgroundColor: (item.priceType === 0 ? '#01A545' : '#fdb93c') }]}>{(item.priceType === 0 ? 'به قیمت' : 'مناسب')}</Text>
                          <Text style={{ fontFamily: 'Dana-FaNum-Medium', fontSize: 12, color: '#01A545', backgroundColor: "#e7f3ef", paddingHorizontal: 20, paddingVertical: 2, borderRadius: 20 }}>{item.transactionType}</Text>
                        </View>
                      </View>
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', borderTopColor: "#ececec", borderTopWidth: 0.8, alignItems: 'center', justifyContent: 'space-between', backgroundColor: "#fff", paddingHorizontal: 20, paddingVertical: 5 }}>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                      <Icon size={22} name={'phone'} color={'#01A545'} style={{ padding: 10, borderRadius: 50, marginRight: 10 }}
